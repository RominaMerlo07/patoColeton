...
namespace GestionJardin
{
    public partial class frmAlumnosGestionar : Form
    {
        ...
        {
            //btnGA_Editar.Enabled = false;
            //btnGA_Eliminar.Enabled = false;            
        }
        ...
        private void btnGA_Agregar_Click(object sender, EventArgs e)
        {
            ...
            frmAlumnosPopUpAgregar.Text = "GESTION ALUMNOS / GESTIONAR ALUMNOS / INGRESAR ALUMNO NUEVO";
        ...
        private void btnGA_Editar_Click(object sender, EventArgs e)
        {
            ...
            frmAlumnosPopUpEditar.Text = "GESTION ALUMNOS / GESTIONAR ALUMNOS / MODIFICAR DATOS ALUMNO";
        ...
        private void btnGA_Eliminar_Click(object sender, EventArgs e)
        {
            ...
            frmAlumnoPopUpEliminar.Text = "GESTION ALUMNOS / GESTIONAR ALUMNOS / ELIMINAR ALUMNO";
